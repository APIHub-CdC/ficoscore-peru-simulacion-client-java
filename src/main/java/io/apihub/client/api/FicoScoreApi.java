...
public class FicoScoreApi {
	...
	public okhttp3.Call ficoScoreCall(String xApiKey, DatosConsulta request,
	...
	private okhttp3.Call ficoScoreValidateBeforeCall(String xApiKey, DatosConsulta request,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (xApiKey == null) {
		...
		okhttp3.Call call = ficoScoreCall(xApiKey, request, progressListener, progressRequestListener);
		return call;
	}

	public Score ficoScore(String xApiKey, DatosConsulta request) throws ApiException {
		ApiResponse<Score> resp = ficoScoreWithHttpInfo(xApiKey, request);
		return resp.getData();
	}

	public ApiResponse<Score> ficoScoreWithHttpInfo(String xApiKey, DatosConsulta request) throws ApiException {
		okhttp3.Call call = ficoScoreValidateBeforeCall(xApiKey, request, null, null);
